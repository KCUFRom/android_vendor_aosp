...
ALARM_PATH := vendor/kcuf/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/kcuf/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/kcuf/prebuilt/common/media/audio/ringtones
